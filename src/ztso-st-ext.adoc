...
[#norm:ztso:vector-mem-RVTSO]#Additionally, if the Ztso extension is implemented, then vector memory
...
supporting Ztso. [#norm:ztso:binary-flag]#Binaries compiled to run only under Ztso should
